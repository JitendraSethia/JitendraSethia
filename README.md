...
## 🚀 Projects
- 🛒 **Farm Link** – voice-enabled, local-language platforms helping farmers access essential services in just 3 taps,  
- 🧠 **RAG-Based Govt Scheme Finder** – AI for Bharat Hackathon  
- 🌐 Websites for clients and self exploration
...
**Backend Technologies:** Node.js | RESTful API Development | Database Design | Admin Dashboard Development | Authentication Systems (OTP Integration with Twilio)  

**AI/ML Technologies:** Machine Learning Fundamentals | Generative AI (GenAI) | Agentic AI Concepts | AI-Assisted Automation Projects  
